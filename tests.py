...
class TestBooksCollector:
    ...
    def test_add_new_book_valid_length_successfully_added(self, collector):
    ...
    def test_add_new_book_invalid_length_not_added(self, name, collector):
        collector.add_new_book(name)
        assert name not in collector.books_genre

    # успешное добавление жанра из genre созданной книге
    def test_set_book_genre_successfully_setted(self, collector):
        collector.add_new_book('Гордость и вафельщик')
    ...
    def test_get_book_genre_successfully_returns_genre(self, collector):
        collector.add_new_book('Гордость и вафельщик')
        collector.set_book_genre('Гордость и вафельщик', 'Комедии')
    ...
    def test_get_books_with_specific_genre_successfully_returns_specific_books(self, collector):
        collector.add_new_book('Гордость и вафельщик')
    ...
    def test_get_books_genre_successfully_returns_books_genre_dictionary(self, collector):
        collector.add_new_book('Yet Another Comedy Book')
        collector.set_book_genre('Yet Another Comedy Book', 'Комедии')
    ...
    def test_get_books_for_children_successfully_returns_books_only_for_children(self, collector):
    ...
    def test_add_book_in_favorites_successfully_adds_book_to_favorites_dictionary(self, collector):
    ...
    def test_delete_book_from_favorites_successfully_removes_book_from_favorites_dictionary(self, collector):
        collector.add_new_book('Люблю эту книгу')
        collector.add_book_in_favorites('Люблю эту книгу')
    ...
    def test_get_list_of_favorites_books_successfully_returns_favorites_dictionary(self, collector):
        collector.add_new_book('Люблю эту книгу')
